...
class User(Base):
    ...
    contact = relationship(Contact, single_parent=True, backref=backref('user', uselist=False))
    ...
    def get(cls, userid):
        ...
        """
        return db_session.query(cls).get(userid)
    ...
    def subscribed_to(self, contact, subtype=None):
        ...
        sub = db_session.query(Subscription).join(SubscriptionGroup). \
